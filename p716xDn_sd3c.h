#ifndef P716XDN_SD3C_H_
#define P716XDN_SD3C_H_
...
public:
    ...
    /// is returned by getBeam(). The user of p716xDn_sd3c should
    ...
    /// @brief Return the DDC decimation factor.
...
protected:
    ...
    /// FEN frequency.)
    /// @param decimation the desired decimation factor
    /// @return true if decimation is set successfully
    void _setDecimation(uint16_t decimation);
