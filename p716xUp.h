...
/// A p716x upconverter. This class manges configuration and
/// operation of the D/A section of the p716x. The device
...
class p716xUp {
    public:
        ...
        // Class p716x is a friend; the intention is that construction of
        // p716xUp will happen only from there...
        friend class p716x;
        
        /// Constructor
        /// @param p716xPtr A pointer to the owner p716x object
        ...
        p716xUp(p716x * p716xPtr, double sampleClockHz,
