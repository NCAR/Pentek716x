...
////////////////////////////////////////////////////////////////////////////////////////
void p716x::_configGlobalParameters() {
    ...
    _globalParams.sbusParams.gateARecSource = P716x_SBUS_CTRL2_GATEA_RCV_SRC_GATE_REG;

    // Set up for data to flow from the DAC (or DAC user block if any) on the 
    // Pentek to the DAC FIFOs (i.e., the DAC output) when the enable bit gets
    // set in the Gate B Generate Register.
    _globalParams.sbusParams.gateBRecSource = P716x_SBUS_CTRL2_GATEB_RCV_SRC_GATE_REG;
}

// XXX This will all happen in p716xUp now....
...
////////////////////////////////////////////////////////////////////////////////////////
void
p716x::_enableAdcOutput() {
    P716xSetGateGenState(_regAddr.gateAGenerate, P716x_GATE_ACTIVE);
    DLOG << "Output to ADC FIFOs enabled";
}

////////////////////////////////////////////////////////////////////////////////////////
void
p716x::_disableAdcOutput() {
    P716xSetGateGenState(_regAddr.gateAGenerate, P716x_GATE_INACTIVE);
    DLOG << "Output to ADC FIFOs disabled";
}
...
p716x::_addUpconverter(p716xUp * upconverter) {
    ...
    if (_upconverter) {
        WLOG << "Existing upconverter is being replaced";
        delete _upconverter;
    }
...
p716x::circuitBoardTemp() const {
    ...
    LM83GetValues(_regAddr.twsiPort1ControlStatus, P716x_LM83_MAIN_PCB_ADDR, 
                  &tempMonValues);
